...
export interface ClienteCreateAcessoData {
  cgc_pessoa: string;
}
...
export interface ClienteRepository{
  create: (data: ClienteCreateAcessoData) => Promise<void>
  update: (data: ClienteUpdateData) => Promise<void>
  findByCliente: (user: string) => Promise<Formulario_Pessoa>
  getFindByID: (id: string) => Promise<Formulario_Pessoa>
